...
styles = [
    ...
    {'color': '#457b9d', 'font-size': '28px'},  # subtitle
    {'color': '#457b9d', 'font-size': '24px'},  # authors
...
# === 第三張投影片：GitHub是什麼 ===
slide3 = Slide()
slide3.add_title("GitHub是什麼?")

content_github = """
GitHub集結了世界各地許多工程師的智慧結晶，舉凡是資料庫、開源程式碼等等這些都可以在 GitHub 上找到相關的資料庫。<br>
AI 神經網絡甚至也可以從中找到模組或者架構，就例如：AI 網路爬蟲、tensorflow 這類的神經網絡架構，因此只要會寫程式或對某個程式應用方面有些許了解，GitHub 上的資料就可以提供強力幫助。<br><br>
